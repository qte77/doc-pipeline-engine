> **Superseded**: This is the original planning doc from project inception.
> Active docs: [architecture.md](../architecture.md), [roadmap.md](../roadmap.md).
> Kept for historical context on design rationale.
